...
namespace its.cam {
    ...
    public class RescueAndRecoveryWorkInProgressSubCauseCode: IASN1PreparedElement {
            ...
            public RescueAndRecoveryWorkInProgressSubCauseCode(int value) {
                this.Value = value;
            }            
            ...
            public void initWithDefaults()
	    {
            ...
            private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(RescueAndRecoveryWorkInProgressSubCauseCode));
