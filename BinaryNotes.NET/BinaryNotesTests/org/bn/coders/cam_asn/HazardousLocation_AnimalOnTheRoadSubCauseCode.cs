...
namespace its.cam {
    ...
    public class HazardousLocation_AnimalOnTheRoadSubCauseCode: IASN1PreparedElement {
            ...
            public HazardousLocation_AnimalOnTheRoadSubCauseCode(int value) {
                this.Value = value;
            }            
            ...
            public void initWithDefaults()
	    {
            ...
            private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(HazardousLocation_AnimalOnTheRoadSubCauseCode));
