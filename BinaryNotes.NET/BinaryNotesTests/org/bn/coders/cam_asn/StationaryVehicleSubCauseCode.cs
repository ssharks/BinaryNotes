...
namespace its.cam {
    ...
    public class StationaryVehicleSubCauseCode: IASN1PreparedElement {
            ...
            public StationaryVehicleSubCauseCode() {
            }

            public StationaryVehicleSubCauseCode(int value) {
                this.Value = value;
            }            
            ...
            public void initWithDefaults()
	    {
            ...
            private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(StationaryVehicleSubCauseCode));
