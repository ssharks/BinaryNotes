...
namespace its.cam {
    ...
    public class SignalViolationSubCauseCode: IASN1PreparedElement {
            ...
            public SignalViolationSubCauseCode() {
            }

            public SignalViolationSubCauseCode(int value) {
                this.Value = value;
            }            
            ...
            public void initWithDefaults()
	    {
            ...
            private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(SignalViolationSubCauseCode));
