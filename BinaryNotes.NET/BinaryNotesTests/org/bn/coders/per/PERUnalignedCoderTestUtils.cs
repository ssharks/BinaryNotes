...
namespace org.bn.coders.per
{
	...
	public class PERUnalignedCoderTestUtils:CoderTestUtilities
	{
        ...
        {
            return new byte[] { (byte)0x82, 0x61, (byte)0xC3, (byte)0x87, 0x08, 0x10, 0x05, 0x50, 0x26, 0x2C, 0x58, (byte)0xB1, 0x00 };
        }
        ...
        {
            return new byte[] { 0x80, 0xb9, 0x80 };
        }
