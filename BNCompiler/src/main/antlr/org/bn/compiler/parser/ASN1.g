...
sequenceof_type returns [Object obj]
...
Object obj1 ; String s;}
	:	(SET_KW	
	(SIZE_KW {setof.isSizeConstraint=true;}(cns = constraint {setof.constraint = cns ;}))? OF_KW 
		(obj1 = type 
		{	if((AsnDefinedType.class).isInstance(obj1)){
