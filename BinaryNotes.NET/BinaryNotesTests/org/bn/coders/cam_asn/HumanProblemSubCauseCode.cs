...
namespace its.cam {
    ...
    public class HumanProblemSubCauseCode: IASN1PreparedElement {
            ...
            public HumanProblemSubCauseCode(int value) {
                this.Value = value;
            }            
            ...
            public void initWithDefaults()
	    {
            ...
            private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(HumanProblemSubCauseCode));
