...
public abstract class DecoderTest {
    ...
    public DecoderTest(CoderTestUtilities coderTestUtils) {
    ...
    private void checkData(Data dec, Data std) {
        if (std.isBinarySelected()) {
            ...
            ByteTools.checkBuffers(dec.getBinary().getValue(), std.getBinary().getValue());
            ...
            ByteTools.checkBuffers(dec.getSimpleOctType(), std.getSimpleOctType());
        }
    }
    ...
    public void testDecode() throws Exception {
        ...
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createDataSeqBytes());
        DataSeq seq = decoder.decode(stream, DataSeq.class);
        checkDataSeq(seq, coderTestUtils.createDataSeq());
    }

    protected void checkDataSeq(DataSeq decoded, DataSeq standard) throws Exception {
        ByteTools.checkBuffers(decoded.getBinary().getValue(), standard.getBinary().getValue());
        ...
        assertEquals(decoded.getPlain().getValue(), standard.getPlain().getValue());
        assertEquals(decoded.getSimpleType(), standard.getSimpleType());
        ByteTools.checkBuffers(decoded.getSimpleOctType(), standard.getSimpleOctType());
    }
    ...
    public void testITUDeDecode() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createITUSeqBytes());
    ...
    private void checkITUSeq(ITUSequence decoded, ITUSequence standard) {
        ...
        assertEquals(decoded.getType2().getValue(), standard.getType2().getValue());
        assertEquals(decoded.getType3().getValue().getValue(), standard.getType3().getValue().getValue());
        assertEquals(decoded.getType4().getValue().getValue().getValue(), standard.getType4().getValue().getValue().getValue());
        assertEquals(decoded.getType5().getValue().getValue(), standard.getType5().getValue().getValue());
        assertEquals(decoded.getType6(), standard.getType6());
        assertEquals(decoded.getType7().getValue(), standard.getType7().getValue());
    }

    @Test
    public void testNullDecode() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createNullSeqBytes());
    ...
    public void testTaggedNullDecode() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createTaggedNullSeqBytes());
        TaggedNullSequence seq = decoder.decode(stream, TaggedNullSequence.class);
        assertNotNull(seq);
    }
    ...
    public void testEnum() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createEnumBytes());
    ...
    public void testSequenceWithEnum() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createSequenceWithEnumBytes());
    ...
    public void testRecursiveDefinition() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createTestRecursiveDefinitionBytes());
        TestRecursiveDefinetion seq = decoder.decode(stream, TestRecursiveDefinetion.class);
        assertNotNull(seq);
    ...
    public void testDecodeInteger() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createTestInteger4Bytes());

        TestI32 val = decoder.decode(stream, TestI32.class);
        assertNotNull(val);
        assertEquals(val.getValue(), coderTestUtils.createTestInteger4().getValue());

        stream = new ByteArrayInputStream(coderTestUtils.createTestInteger3Bytes());
        TestI16 val16 = decoder.decode(stream, TestI16.class);
        assertNotNull(val16);
        assertEquals(val16.getValue(), coderTestUtils.createTestInteger3().getValue());

        stream = new ByteArrayInputStream(coderTestUtils.createTestInteger2Bytes());
        val16 = decoder.decode(stream, TestI16.class);
        assertNotNull(val16);
        assertEquals(val16.getValue(), coderTestUtils.createTestInteger2().getValue());

        stream = new ByteArrayInputStream(coderTestUtils.createTestInteger1Bytes());
        TestI8 val8 = decoder.decode(stream, TestI8.class);
        assertNotNull(val8);
        assertEquals(val8.getValue(), coderTestUtils.createTestInteger1().getValue());

        stream = new ByteArrayInputStream(coderTestUtils.createTestIntegerRBytes());
        TestIR valR = decoder.decode(stream, TestIR.class);
        assertNotNull(valR);
        assertEquals(valR.getValue(), coderTestUtils.createTestIntegerR().getValue());

        stream = new ByteArrayInputStream(coderTestUtils.createTestInteger2_12Bytes());
        TestI14 val14 = decoder.decode(stream, TestI14.class);
        assertNotNull(val14);
        assertEquals(val14.getValue(), coderTestUtils.createTestInteger2_12().getValue());
    }

    @Test
    public void testDecodeString() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createTestPRNBytes());
    ...
    public void testDecodeStringArray() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createStringArrayBytes());
    ...
    public void testDecodeChoice() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createDataChoicePlainBytes());
    ...
    public void testDecodeNegativeInteger() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createTestNIBytes());
        TestNI val = decoder.decode(stream, TestNI.class);
        assertEquals(val.getValue(), coderTestUtils.createTestNI().getValue());

        stream = new ByteArrayInputStream(coderTestUtils.createTestNI2Bytes());
    ...
    public void testDecodeSet() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createSetBytes());
    ...
    public void testDecodeBitStr() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createTestBitStrBytes());
    ...
    public void testDecodeUnicodeStr() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createUnicodeStrBytes());
    ...
    public void testDecodeVersion1_2() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createTestSequenceV12Bytes());
    ...
    public void testDecodeChoiceInChoice() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createChoiceInChoiceBytes());
    ...
    public void testDecodeChoiceInChoice2() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createChoiceInChoice2Bytes());
    ...
    public void testDecodeReal() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createTestReal1_5Bytes());
        TestReal val = decoder.decode(stream, TestReal.class);
        assertEquals(val.getValue(), coderTestUtils.createTestReal1_5().getValue());

        stream = new ByteArrayInputStream(coderTestUtils.createTestReal0_5Bytes());
        val = decoder.decode(stream, TestReal.class);
        assertEquals(val.getValue(), coderTestUtils.createTestReal0_5().getValue());

        stream = new ByteArrayInputStream(coderTestUtils.createTestReal2Bytes());
        val = decoder.decode(stream, TestReal.class);
    ...
    public void testDecodeChoiceInChoice3() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createChoiceInChoice3Bytes());
        BugList val = decoder.decode(stream, BugList.class);
        //assertEquals(val.getAttrInt(), coderTestUtils.createTestSequenceV12().getAttrInt());        
        assertNotNull(val.getValue());
        assertTrue(!val.getValue().isEmpty(), "Is not empty");
    ...
    public void testDecodeTaggedSeqInSeq() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createTaggedSeqInSeqBytes());
    ...
    public void testSequenceWithNullDecode() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createSeqWithNullBytes());
    ...
    public void testDecodeLongTag2() throws Exception {
        IDecoder decoder = newDecoder();
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createTestLongTag2Bytes());
    ...
    public void testDecodeOID() throws Exception {
        ...
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createTestOID1Bytes());
    ...
    public void testDecodeTaggedSet() throws Exception {
        ...
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createTaggedSetBytes());
    ...
    public void testDecodeTaggedSetInSet() throws Exception {
        ...
        ByteArrayInputStream stream = new ByteArrayInputStream(coderTestUtils.createTaggedSetInSetBytes());
        TestTaggedSetInSet tset = decoder.decode(stream, TestTaggedSetInSet.class);
        stream = new ByteArrayInputStream(coderTestUtils.createSet7Bytes());
