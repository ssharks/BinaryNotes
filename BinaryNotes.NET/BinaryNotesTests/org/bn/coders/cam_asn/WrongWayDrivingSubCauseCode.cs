...
namespace its.cam {
    ...
    public class WrongWayDrivingSubCauseCode: IASN1PreparedElement {
            ...
            public WrongWayDrivingSubCauseCode(int value) {
                this.Value = value;
            }            
            ...
            public void initWithDefaults()
	    {
            ...
            private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(WrongWayDrivingSubCauseCode));
