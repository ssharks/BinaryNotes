...
namespace its.cam {
    ...
    public class ProtectedZoneID: IASN1PreparedElement {
            ...
            public ProtectedZoneID() {
            }

            public ProtectedZoneID(int value) {
                this.Value = value;
            }            
            ...
            public void initWithDefaults()
	    {
            ...
            private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(ProtectedZoneID));
