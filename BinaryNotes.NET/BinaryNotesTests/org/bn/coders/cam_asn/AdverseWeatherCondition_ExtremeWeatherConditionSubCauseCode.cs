...
namespace its.cam {
    ...
    public class AdverseWeatherCondition_ExtremeWeatherConditionSubCauseCode: IASN1PreparedElement {
            ...
            public AdverseWeatherCondition_ExtremeWeatherConditionSubCauseCode() {
            }

            public AdverseWeatherCondition_ExtremeWeatherConditionSubCauseCode(int value) {
                this.Value = value;
            }            
            ...
            public void initWithDefaults()
	    {
            ...
            private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(AdverseWeatherCondition_ExtremeWeatherConditionSubCauseCode));
